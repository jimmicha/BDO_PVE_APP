...
export interface Snapshot {profile:Profile;is_admin:boolean;game_profiles:Family[];characters:Character[];equipment:Equipment[];resources:Resource[];goals:Goal[];steps:Step[];allocations:Allocation[];claims:Claim[];events:ProgressEvent[];catalogs:Catalog[]}
